...
Plugin URI: http://wordpress.org/extend/plugins/personal-favicon/
Description: Personal Favicon is plugin that enable to customize favicon for your Blog.
Version: 2.0
Author: Dejan Major - mangup
Author URI: http://wordpress.org/extend/plugins/personal-favicon/
*/
...
$gfile = dirname(__FILE__) . '/personal favicon.php';
